...
function SendFriendMessage(UserID, FriendID, Message) {
    return __awaiter(this, void 0, void 0, function* () {
        yield RedisHandle.RedisMessageList(UserID, FriendID, Message);
    });
}
function SendGroupMessage(UserID, GroupID, Message) {
    return __awaiter(this, void 0, void 0, function* () {
        yield RedisHandle.RedisMessageList(UserID, GroupID, Message);
    });
}
